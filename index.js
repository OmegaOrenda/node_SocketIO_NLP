...
async function botstr(findStr){
      ...
      manager.addDocument('en',"yeah",'yes');
      manager.addDocument('en',"ya",'yes');
      manager.addDocument('en',"no",'no');
      manager.addDocument('en',"nah",'no');
      manager.addDocument('en',"1998-04-02",'birthdate');
      manager.addDocument('en',"2000-03-20",'birthdate');
      manager.addDocument('en',"1678-08-30",'birthdate');
      ...
      manager.addAnswer('en', 'yes', '"Please enter you Date of birth in order YYYY/MM/DD"');
      manager.addAnswer('en', 'no', 'Goodbye :)');
      manager.addAnswer('en', 'birthdate', 'Goodbye12');
